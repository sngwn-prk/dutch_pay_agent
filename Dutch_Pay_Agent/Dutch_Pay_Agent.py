...
def calculate_dutch_pay(df):
    ...
    for idx, row in df.iterrows():
        ...
        part_result_df = pd.DataFrame({'from':participants_lst,
...
with main_site:
    ...
    names_str = st.text_area("(Enter one name per line.)", 
                            placeholder ="ex: Alex\nJamie\nTaylor")
    ...
    if st.session_state['enter_names']== True:
        ...
        st.markdown("And please activate the checkbox for those who did not participate in splitting the bill for each payment.")
